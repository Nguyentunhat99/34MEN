...
class GalleryController extends Controller
{
    ...
    public function select_gallery(Request $request) {
        ...
        if ($gallery_count > 0) {
            ...
            foreach($gallery as $key => $gal){
                ...
                <td>
                <img src="'.url('public/uploads/gallery/'.$gal->gallery_image).'" class="img thumbnail" witdh="120px" height="120px">
                <input type="file" class="file_image" style="witdh:40%" data-gal_id="'.$gal->gallery_id.'" id="file-'.$gal->gallery_id.'" name="file" accept="image/*">
                </td>
                <td>
    ...
    public function insert_gallery(Request $request, $pro_id) {
        ...
        Session::put('message','Thêm thư viện ảnh thành công thành công');
