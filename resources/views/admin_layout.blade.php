            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="{{URL::to('/impersonate-destroy')}}">
                        <i class="fa fa-book"></i> Dừng chuyển quyền</a></span>
                    </a>
                </li>
                @endimpersonate
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#file').change(function(){
            ...
            if (file.length > 5) {
                error +='<p>Chỉ chon được tối đa 5 ảnh</p>';
            }
            else if(file.length == ''){
                error +='<p>Chưa chọn ảnh nào</p>';
            }
            else if(file.size > 2000000){
                error +='<p>Kích thước quá 2MB</p>';
            }
        ...
        $(document).on('blur','.edit_gal_name',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                   load_gallery();
                    $('#error_gallery').html('<span class="text-danger">Cập nhật tên hình ảnh thành công</spam>');
                }
            });
        });
        $(document).on('click','.delete-gallery',function(){
            ...
            if (confirm('Bạn có muốn xóa ảnh này không')) {
                $.ajax({
                    ...
                    success:function(data){
                       load_gallery();
                        $('#error_gallery').html('<span class="text-danger">Xóa hình ảnh thành công</spam>');
                    }
                });
            }
        });
        ...
        $(document).on('change','.file_image',function(){
            ...
            form_data.append("gal_id",gal_id);
                $.ajax({
                    ...
                    success:function(data){
                       load_gallery();
                        $('#error_gallery').html('<span class="text-danger">Cập nhật hình ảnh thành công</spam>');
                    }
                });
            // }
        });
    ...
    $(document).ready(function(){
        ...
        $(document).on('blur','.video_edit',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                   load_gallery();
                    $('#notify').html('<span class="text-success">Cập nhật video thành công</spam>');
                }
            });
        });
        $(document).on('click','.btn-delete-video',function(){
            ...
            if (confirm('Bạn có muốn xóa video này không')) {
                $.ajax({
                    ...
                    success:function(data){
                       load_video();
                        $('#notify').html('<span class="text-danger">Xóa video thành công</spam>');
                    }
                });
            }
        });
        ...
        $(document).on('change','.file_img_video',function(){
            ...
            form_data.append("video_id",video_id);
                $.ajax({
                    ...
                    success:function(data){
                        load_video();
                        $('#notify').html('<span class="text-danger">Cập nhật hình ảnh video thành công</spam>');
                    }
                });
        });
    });
...
<script type="text/javascript">
    $('.comment_browser_btn').click(function (){
        ...
        if (comment_status == 0) {
            var alert = 'Bạn đã duyệt bình luận';
        }else{
