                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control"  name="cate_post_name" onkeyup="ChangeToSlug();" id="slug" placeholder="danh mục" >
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="add_cate_post" class="btn btn-info">Thêm danh mục</button>
                                </form>
                            </div>
