                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="ckeditor8" style="resize: none" rows="8" class="form-control" name="brand_product_desc" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Từ khóa thương hiệu</label>
                                    <textarea id="ckeditor9" style="resize: none" rows="8" class="form-control" name="brand_product_keywords" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
